...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_File.setGeometry(QRect(23, 35, 71, 22))
        ...
        self.pushButton_Info.setGeometry(QRect(290, 340, 100, 30))
        self.pushButton_Settings = QPushButton(self.centralwidget)
        self.pushButton_Settings.setObjectName("pushButton_Settings")
        self.pushButton_Settings.setGeometry(QRect(110, 340, 100, 30))
