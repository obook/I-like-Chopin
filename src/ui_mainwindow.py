...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(509, 534)
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(MainWindow.sizePolicy().hasHeightForWidth())
        MainWindow.setSizePolicy(sizePolicy)
        icon = QIcon(QIcon.fromTheme(u"audio-volume-high"))
        ...
        self.pushButton_Mode.setGeometry(QRect(70, 180, 401, 30))
        ...
        self.label_Mode.setGeometry(QRect(18, 184, 71, 22))
        ...
        self.label_midipath = QLabel(self.groupBox)
        self.label_midipath.setObjectName(u"label_midipath")
        self.label_midipath.setGeometry(QRect(70, 150, 401, 17))
        self.groupBox_2 = QGroupBox(self.centralwidget)
        self.groupBox_2.setObjectName(u"groupBox_2")
        self.groupBox_2.setGeometry(QRect(10, 235, 481, 141))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_midipath.setText(QCoreApplication.translate("MainWindow", u"PATH:", None))
