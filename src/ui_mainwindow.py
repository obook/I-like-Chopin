...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_Replay = QPushButton(self.groupBox_3)
        self.pushButton_Replay.setObjectName(u"pushButton_Replay")
        self.pushButton_Replay.setEnabled(True)
        self.pushButton_Replay.setGeometry(QRect(245, 30, 100, 30))
        self.pushButton_Replay.setCheckable(False)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_Replay.setText(QCoreApplication.translate("MainWindow", u"Replay", None))
