...
from PySide6.QtWidgets import (QApplication, QCheckBox, QDialog, QFormLayout,
    QGroupBox, QPushButton, QSizePolicy, QTextBrowser,
    QWidget)
...
class Ui_DialogInformation(object):
    def setupUi(self, DialogInformation):
        ...
        self.pushButton_Close.setGeometry(QRect(200, 320, 81, 25))
        self.groupBox = QGroupBox(DialogInformation)
        self.groupBox.setObjectName(u"groupBox")
        self.groupBox.setGeometry(QRect(10, 250, 461, 61))
        ...
        self.textBrowser.setGeometry(QRect(10, 10, 301, 241))
        self.formLayoutWidget = QWidget(DialogInformation)
        self.formLayoutWidget.setObjectName(u"formLayoutWidget")
        self.formLayoutWidget.setGeometry(QRect(320, 10, 141, 241))
